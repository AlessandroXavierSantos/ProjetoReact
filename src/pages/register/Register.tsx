        ...
        <div>
            ...
            <section className='mid' >
                <div className='disciplinas'>
                    {
                        component == "1" ? <Professor /> :
                        component == "2" ? <Turma /> : 
                        component == "3" ? <Disciplina /> : null
                    }
                </div>
            </section>
            <section className='bottom'>
                ...
                <footer>
                    <div className='nav_boxes'>
                        <button onClick={() => {setComponent("1")}} className={`svg ${"1" == component ? "active" : ""}`}>
                        ...
                        <button autoFocus  onClick={ () => {setComponent("2")}} className={`svg ${"2" == component ? "active" : ""}`}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button onClick={ () => {setComponent("3")}} className={`svg ${"3" == component ? "active" : ""}`}>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
